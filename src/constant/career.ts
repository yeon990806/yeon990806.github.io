...
상태 관리를 위한 bloc 패턴에 대한 얕은 이해도로 인해 프로젝트 초반에 많이 헤맸던 기억이 남습니다.
  `
      },
      {
...
하지만 vue를 처음 적용하게 되면서 데이터 핸들링에 미숙했던 기억이 있습니다.
`
      },
      {
...
환불 기능에서의 문제 때문에 인력 부족을 이유로 CS도 해본 경험을 얻을 수 있었습니다.
`
      },
      {
...
`
      },
      {
        ...
        desc: `인터렉티브한 움직임으로 랜딩 페이지에 사용자의 주목도를 높였음.`
      }, 
    ]
  },
  {
...
개발자로 전향하고 맡은 첫 프로젝트였고, 그래서 비동기 통신에 대한 이해, 백엔드 아키텍쳐에 대한 이해가 얕은 체로 일을 하게 되어 잦은 야근을 하게 되었습니다.
...
`
      },
      {
        ...
        desc: `HTML5 기반 WYSIWYG Framework의 기능 몇가지를 맡아 개발함`
      },
      {
...
`
      },
      {
        ...
        desc: '개인택시공제조합, 도서관, 공공기관 등의 프로젝트에서 메인 퍼블리싱 역할을 수행함'
      }
    ]
  }
];